...
class Admin::CommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_comment" do
    assert_difference("Admin::Comment.count") do
      post admin_comments_url, params: { admin_comment: { content: @admin_comment.content, post_id: @admin_comment.post_id, status: @admin_comment.status, user_id: @admin_comment.user_id } }
    end
  ...
  test "should update admin_comment" do
    patch admin_comment_url(@admin_comment), params: { admin_comment: { content: @admin_comment.content, post_id: @admin_comment.post_id, status: @admin_comment.status, user_id: @admin_comment.user_id } }
