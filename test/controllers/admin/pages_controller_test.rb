...
class Admin::PagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_page" do
    assert_difference("Admin::Page.count") do
      post admin_pages_url, params: { admin_page: { content: @admin_page.content, parent_id: @admin_page.parent_id, published_at: @admin_page.published_at, slug: @admin_page.slug, status: @admin_page.status, title: @admin_page.title, user_id: @admin_page.user_id } }
    end
  ...
  test "should update admin_page" do
    patch admin_page_url(@admin_page), params: { admin_page: { content: @admin_page.content, parent_id: @admin_page.parent_id, published_at: @admin_page.published_at, slug: @admin_page.slug, status: @admin_page.status, title: @admin_page.title, user_id: @admin_page.user_id } }
