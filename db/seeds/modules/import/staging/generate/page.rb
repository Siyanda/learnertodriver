...
pages = [
  ...
  { 'title' => 'Terms & Conditions', 'content' => rendered_md('page/terms'), 'slug' => 'terms',
    'status' => 'published', 'editor_id' => User.first.id, 'parent_id' => '' },
  ...
  { 'title' => 'Account Ownership Information', 'content' => rendered_md('page/account-ownership-information'),
    'slug' => 'account-ownership-information', 'status' => 'published', 'editor_id' => User.first.id, 'parent_id' => '' },
  ...
  { 'title' => 'Support Community', 'content' => rendered_md('page/community'), 'slug' => 'community',
    'status' => 'published', 'editor_id' => User.first.id, 'parent_id' => '' },
  { 'title' => 'Contact Us', 'content' => rendered_md('page/contact'), 'slug' => 'contact', 'status' => 'published',
    'editor_id' => User.first.id, 'parent_id' => '' },
  { 'title' => 'How to manage the account of someone who is incapacitated or has died',
    'content' => rendered_md('page/incapacitated'), 'slug' => 'incapacitated', 'status' => 'published', 'editor_id' => User.first.id, 'parent_id' => '' },
