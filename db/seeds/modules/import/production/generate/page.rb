...
'user_id' => User.first.id, 'parent_id' => '' },
  { 'title' => 'Conduct', 'content' => rendered_md('page/conduct'), 'slug' => 'conduct',
...
'status' => 'published', 'user_id' => User.first.id, 'parent_id' => '' },
  { 'title' => 'Contact', 'content' => rendered_md('page/contact'), 'slug' => 'contact',
'status' => 'published', 'user_id' => User.first.id, 'parent_id' => '' },
...
'status' => 'published', 'user_id' => User.first.id, 'parent_id' => '' },
  { 'title' => 'Policies', 'content' => rendered_md('page/policies'), 'slug' => 'policies',
'status' => 'published', 'user_id' => User.first.id, 'parent_id' => '' },
  { 'title' => 'Privacy Policy', 'content' => rendered_md('page/privacy'), 'slug' => 'privacy',
'status' => 'published', 'user_id' => User.first.id, 'parent_id' => '' },
  { 'title' => 'Purpose', 'content' => rendered_md('page/purpose'), 'slug' => 'purpose',
'status' => 'published', 'user_id' => User.first.id, 'parent_id' => '' },
  { 'title' => 'Refund Policy', 'content' => rendered_md('page/refund'), 'slug' => 'refund',
'status' => 'published', 'user_id' => User.first.id, 'parent_id' => '' },
