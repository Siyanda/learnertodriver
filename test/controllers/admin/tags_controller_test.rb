...
class Admin::TagsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_tag" do
    assert_difference("Admin::Tag.count") do
      post admin_tags_url, params: { admin_tag: { slug: @admin_tag.slug, status: @admin_tag.status, title: @admin_tag.title } }
    end
  ...
  test "should update admin_tag" do
    patch admin_tag_url(@admin_tag), params: { admin_tag: { slug: @admin_tag.slug, status: @admin_tag.status, title: @admin_tag.title } }
