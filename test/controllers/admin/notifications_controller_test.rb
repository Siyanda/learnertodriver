...
class Admin::NotificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_notification" do
    assert_difference("Admin::Notification.count") do
      post admin_notifications_url, params: { admin_notification: { content: @admin_notification.content, notifiable_id: @admin_notification.notifiable_id, notifiable_type: @admin_notification.notifiable_type } }
    end
  ...
  test "should update admin_notification" do
    patch admin_notification_url(@admin_notification), params: { admin_notification: { content: @admin_notification.content, notifiable_id: @admin_notification.notifiable_id, notifiable_type: @admin_notification.notifiable_type } }
