...
class Admin::PostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_post" do
    assert_difference("Admin::Post.count") do
      post admin_posts_url, params: { admin_post: { content: @admin_post.content, excerpt: @admin_post.excerpt, published_at: @admin_post.published_at, slug: @admin_post.slug, status: @admin_post.status, title: @admin_post.title, user_id: @admin_post.user_id } }
    end
  ...
  test "should update admin_post" do
    patch admin_post_url(@admin_post), params: { admin_post: { content: @admin_post.content, excerpt: @admin_post.excerpt, published_at: @admin_post.published_at, slug: @admin_post.slug, status: @admin_post.status, title: @admin_post.title, user_id: @admin_post.user_id } }
